# Modify model structure params and training settings the same as UACMDet.
# model settings
angle_version = 'le90'
model = dict(
    type='BimodalRotatedTwoStageDetector',
    backbone1=dict(
        type='ResNet',
        depth=50,
        num_stages=4,

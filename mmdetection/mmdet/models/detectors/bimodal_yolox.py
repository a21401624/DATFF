...
from .bimodal_single_stage import BimodalSingleStageDetector


@DETECTORS.register_module()
class BimodalYOLOX(BimodalSingleStageDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(BimodalYOLOX, self).__init__(backbone1, backbone2, fusion_neck, neck, bbox_head, 
    ...
    def forward_train(self,
        ...
        img1, img2, gt_bboxes = self._preprocess(img1, img2, gt_bboxes)

        losses = super(BimodalYOLOX, self).forward_train(img1, img2, img_metas, gt_bboxes,
                                                  gt_labels, gt_bboxes_ignore)

        # random resizing
        if (self._progress_in_iter + 1) % self._random_size_interval == 0:
            self._input_size = self._random_resize(device=img1.device)
        self._progress_in_iter += 1

        return losses

    def _preprocess(self, img1, img2, gt_bboxes):
